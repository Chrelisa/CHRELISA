...
document.querySelectorAll('.category-card, .product-card, .benefit-item').forEach(el => {
    el.style.opacity = '0';
    observer.observe(el);
});
...
document.querySelectorAll('.category-link').forEach(link => {
    link.addEventListener('click', (e) => {
        e.preventDefault();
        showNotification('Explore this collection', 'info');
    });
});
...
// Load event - initialize when page is fully loaded
window.addEventListener('load', () => {
    console.log('CHRELISA Landing Page Loaded Successfully');
});
